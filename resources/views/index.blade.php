...
@section('content')
  <div class="w3-display-container">
    <img class="mySlides w3-animate-fading" src="/images/img_nature_wide.jpg" style="width:100%">
    <img class="mySlides w3-animate-fading" src="/images/img_fjords_wide.jpg" style="width:100%">
    <img class="mySlides w3-animate-fading" src="/images/img_mountains_wide.jpg" style="width:100%">
  ...
  <div class="w3-container w3-row">
    <div class="w3-col m4 l3">
      <img src="/images/img_nature_wide.jpg" style="width:100%;height:200px">
    </div>
    <div class="w3-col w3-container m8 l9">
      <h2>Presiden Jokowi Groundbreaking Double Track Bogor</h2>
        <table class="spacing">
          <td><i class="fa fa-user w3-small w3-left" aria-hidden="true"></i></td>
          <td><p class="w3-left">Nama Orang</p></td>
          <td>&nbsp;&nbsp;</td>
          <td><i class="fa fa-calendar w3-small w3-left" aria-hidden="true"></i></td>
          <td><p>tanggal</p></td>
          <td>&nbsp;&nbsp;</td>
